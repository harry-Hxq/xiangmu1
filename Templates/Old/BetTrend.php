	...
	<div class="g_w1000min open_form">
		<div class="sub_right  ">
			...
			<style>
				...
				.top_right { border-bottom: 1px solid #e3e3e3; font-size: 20px; height: 25px; line-height: 25px; }
				.top_right_red { border-bottom: 1px solid #e3e3e3; color: red; font-size: 20px; height: 25px; line-height: 25px; }
