...
if($type == 'getuser'){
    ...
    foreach($cons as $con){
        ...
        $arr['data'][] = array($con['id'], $con['username'], $sf, $xf, $yk, $allm,$con['money'],"<a href=\"#\" onclick=\"disreport('".$con['id']."','".$con['username']."')\" class=\"btn btn-success btn-sm\">报表查询</a>");
		}
    }
	//zong gezi
	$arr['data'][] = array('合计', '', $ALL_sf, $ALL_xf, $ALL_yk, $ALL_allm,'','');
